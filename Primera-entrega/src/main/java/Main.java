...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            System.out.println(producto.readById(2));
            invoiceDetail.addToInvoiceDetail(2, producto.readById(1).getPrice(), cliente.readById(3), producto.readById(1));
            ...
            invoiceDetail.removeToInvoiceDetail(3);
            System.out.println("Detalles de compra sin el detalle de id 3: ");
            System.out.println(invoiceDetail.readAll());

            //Crear factura
            System.out.println("Creando Factura");
            InvoiceManager invoice = new InvoiceManager();
            invoice.create(invoiceDetail.readById(1));
            invoice.create(invoiceDetail.readById(2));

            //Buscar todas las facturas, buscar por cliente y por id.
            System.out.println("Facturas del cliente con id 1: ");
            System.out.println(invoice.readByClient(cliente.readById(1)));
            System.out.println("Factura con id 2: ");
            System.out.println(invoice.readById(2));
